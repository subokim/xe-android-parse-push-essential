...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cookieManager.setCookie("http://manwal.cafe24.com", "app=1");
        ...
        if (MainApplication.is_push == true) {
            if (ParseInstallation.getCurrentInstallation().getObjectId() == null) {
                ParseInstallation.getCurrentInstallation().saveInBackground(new SaveCallback() {
                    ...
                    public void done(com.parse.ParseException arg0) {
                        ...
                        SiteView.loadUrl("http://manwal.cafe24.com/?m=1&obid=" + objectId);
                    }
                });
            } else {
                objectId = ParseInstallation.getCurrentInstallation().getObjectId();
            ...
            SiteView.loadUrl("http://manwal.cafe24.com/?m=1");
        }
    ...
    class MyView extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (!url.startsWith("http://manwal.cafe24.com") && !url.startsWith("https://manwal.cafe24.com")) {
